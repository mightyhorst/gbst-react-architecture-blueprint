...
import { Table, Button } from 'gel-generic';
import { Layouts } from 'gel-generic';

export const InputControlExample = <Form>
    <FormGroup>
...
export const InputCtrlValidationExample = <React.Fragment>
...
export const InputCtrlValidationPrefixExample = <React.Fragment>
    <FormGroup validationState="success">
...
export const InputCtrlSizeExample = <React.Fragment>
...
export const InputCtrlTableExample = <Table id="input-table" keyField="id" data={tableInputTestData} columns={columnData} />;
